      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="bg-gray-900 rounded-2xl p-8 space-y-4 border border-gray-800">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-xl bg-white text-gray-900 font-medium py-3 px-4 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <GoogleIcon />
